...
export default function TC() {
  ...
  const termsConditions = [
    "<span style='font-weight: bolder; font-size: larger'>Refund Policy and Ticket Assignment.</span> All sales are final. Except as may be outlined in these terms and conditions, no refund, no exchange and no cancellation permitted. Purchased Tickets are not assignable, transferable, or re-saleable to any third party.",    "<span style='font-weight: bolder; font-size: larger'>Method of Payment:</span> Card Types accepted and Currency: Inclusion is mandatory and below is the recommended statement subject to amendment as applicable. “We accept payments online using Visa and MasterCard credit/debit card in AED (or any other agreed currency)”. The logo of the accepted cards is to be mentioned on their Home page and on their Payment check out page.",
