...
export default function TC() {
  ...
  const termsConditions = [
    ...
    "If an event is postponed or rescheduled, Purchased Tickets will be honored for the rescheduled date. New tickets generally will not need to be issued; in the rare case that new tickets are needed, Purchaser will be contacted by the Seller.",
    ...
    "No food, beverage, cameras, drones, dangerous substances, recording devices, BBQ equipment or tools, or any other equipment or material shall be allowed on the event premises unless expressly permitted by the Seller.",
    "Minimum age allowed to the event shall be 18 years. 17 years and less are not permitted at the venue for safety reasons.",
    "<span style='font-weight: bolder; font-size: larger'>Fraudulent Use.</span> To protect Purchaser from fraud, Purchaser may be required to provide additional proof of identify on any order. Proof of identity may include but is not limited to a signed credit card authorization and/or photocopies of government issued photo ID.",
    ...
    "Seller may collect and use Purchaser’s personal information, limited to name, contact details and transactional history, for transactional purposes, including those related to customer service for the transaction and to market the products and services of the Seller. Purchaser shall, at all times, have the right to opt out of and stop receiving promotional or marketing communication from Seller by notifying the Seller in writing or via the opt-out link provided in the communication or through any other method provided by the Seller.",
  ];
  return (
          ...
          <div className="my-3 flex flex-col gap-[30px]">
            <div className="ml-[1.5rem]">
              <div className="mb-3 text-[12px]">
                The following are the terms and conditions of the direct ticket
                sale between Tanweer Festival LLC - SP (the <span style={{fontWeight: 'bolder', fontSize: 'larger'}}>“Seller”</span>) and
